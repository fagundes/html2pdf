<style type="text/css">
<!--
    table.page_header-impar {width: 100%; border: none; background-color: #DDDDFF; border-bottom: solid 1mm #AAAADD; padding: 2mm }
    table.page_header-par {width: 100%; border: none; background-color: #DDFFFF; border-bottom: solid 1mm #AADDDD; padding: 2mm }
    table.page_footer-impar {width: 100%; border: none; background-color: #DDDDFF; border-top: solid 1mm #AAAADD; padding: 2mm}
    table.page_footer-par {width: 100%; border: none; background-color: #DDFFFF; border-top: solid 1mm #AADDDD; padding: 2mm}
...
<page backtop="14mm" backbottom="14mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
    <page_header showOn="/^\d*[02468]$/">
        <table class="page_header-par">
            <tr>
    ...
    <page_header showOn="/^\d*[13579]$/">
        <table class="page_header-impar">
            <tr>
                <td style="width: 50%; text-align: left">
                    HTML2PDF v<?php echo $html2pdf->getVersion(); ?>
                </td>
  ...
  <page_footer  showOn="/^\d*[02468]$/">
        <table class="page_footer-par">
            <tr>
                <td style="width: 33%; text-align: left;">
                    http://html2pdf.fr/
                </td>
